...
Учебный проект мессенджера для курса Яндекс Практикума. Сейчас проект находится на ранней стадии разработки: реализована статическая верстка страниц на Handlebars и CSS, подключена сборка через Vite, внедрен TypeScript и паттерн MVC.
